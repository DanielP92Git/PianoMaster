...
- [ ] **Phase 6: Dedicated Parent Portal with Math Gate** - Redesign /parent-portal as a dedicated, ParentGateMath-guarded parent area with easy entry point
...
**Goal**: Redesign /parent-portal as a dedicated, ParentGateMath-guarded parent area. Currently only accessible through subscription section in Settings (confusing UX). Parents need an easy but gated entry point to access: subscription management, child's practice heatmap, and future parent-facing features. Use existing ParentGateMath component as the gate.
**Depends on**: Phase 4 (Parent Calendar Heatmap)
**Requirements**: TBD
**Plans**: TBD
**UI hint**: yes
...
| 6. Parent Portal Redesign | v2.7 | 0/? | Not started | - |

# Requirements Archive: v2.9 Game Variety & Ear Training
...
- [x] **EAR-01**: 12-15 ear training nodes across 2 units with progressive difficulty
- [x] **EAR-02**: Ear Training tab visible on TrailMap with distinct color palette
- [x] **EAR-03**: Nodes use PITCH_COMPARISON and INTERVAL_ID exercise types
- [x] **EAR-04**: Free tier ear training nodes defined in subscriptionConfig.js and synced with Postgres is_free_node()
- [x] **EAR-05**: Boss node(s) combining ear training skills
...
| EAR-01 | Phase 10 | Complete |
| EAR-02 | Phase 10 | Complete |
| EAR-03 | Phase 10 | Complete |
| EAR-04 | Phase 10 | Complete |
| EAR-05 | Phase 10 | Complete |

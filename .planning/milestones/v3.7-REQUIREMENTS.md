# Requirements Archive: v3.7 Sight-Reading Engagement & Pedagogy
...
- [ ] ~~**PRAC-02**: In the feedback phase the player can hear a played-vs-correct comparison playback (their rendition vs the correct one).~~ **DEFERRED** (owner playtest, 2026-07-18) — built and device-verified working (both passes play with "Yours"/"Correct" labels after the `onComplete` playback fix, commit `4e37ac3d`), then **hidden** via `SHOW_COMPARE_FEATURE=false` (commit `9f199a00`) because the "Hear yours vs correct" control made the post-exercise screen too busy for the 8-year-old audience. The feature is intact behind a one-line flag; reconsider re-enabling with a simpler affordance in a later milestone. Mirrors the HUD-02 deferral pattern.
...
| PRAC-02     | Phase 02    | Deferred (2026-07-18) |
...
- v1 requirements: 12 total (10 shipped + 2 deferred)
- Shipped: 10 (HUD-01, HUD-03, PRAC-01, PRAC-03, PRAC-04, ADAPT-01..04, I18N-01)
- Deferred: 2 — HUD-02 (lives/game-over, dropped 2026-07-09) and PRAC-02 (comparison playback:
  built + device-verified, hidden 2026-07-18 as too busy for 8-year-olds)
- Unmapped: 0 ✓
- Open at close: PRAC-04's mic review UAT (item 2) still pending device sign-off (accepted)
...
_Last updated: 2026-07-18 — PRAC-02 (comparison playback) deferred at milestone close: built and device-verified working, then hidden as too busy for the 8-year-old audience. Prior update 2026-07-09: HUD-02 (lives/game-over) deferred for positive-only engagement; HUD-01 refined to session-wide, live note-by-note combo._

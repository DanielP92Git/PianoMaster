...
must_haves:
  ...
  artifacts:
    ...
    - path: "src/utils/musicSymbolShapes.js"
      ...
      exports: ["drawQuarterNote", "drawEighthNote", "drawTrebleClef", "drawSharp", "MUSIC_SHAPES"]
...
<task type="auto">
  ...
  **musicSymbolShapes.js:**
  ...
  - Verify exports: `grep -c "export" src/utils/musicSymbolShapes.js` shows at least 6 (5 functions + MUSIC_SHAPES + getRandomMusicShape)

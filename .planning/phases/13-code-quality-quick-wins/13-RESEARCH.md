...
| QUAL-05 | Non-migration files removed from supabase/migrations/ (DEBUG_, TEST_, README_) | Confirmed: `DEBUG_check_teacher_status.sql`, `README_USER_PREFERENCES.md`, `TEST_direct_insert.sql` all exist. |
...
*(AchievementsLegacy, migration file deletions, lazy load, and locale changes do not require new test files — verified by build and grep)*

...
dependency_graph:
  ...
  affects: [RhythmReadingGame, RhythmStaffDisplay, validateTrail, rhythm-unit-files]
tech_stack:
  added: []
  patterns: [multi-stave-vexflow, resolveByTags-curated-feed, build-time-policy-enforcement]
key_files:
  created: []
  modified:

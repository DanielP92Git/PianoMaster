...
```javascript
['quarter', 'half', 'whole', 'eighth', 'dotted-quarter', 'dotted-eighth', 'dotted-half',
 'quarter-triplet', 'eighth-triplet', 'sixteenth-triplet', 'sixteenth']
```
...
if (allowedPatterns && allowedPatterns.length > 0) {
  ...
  if (effectiveSubdivisions.length === 0) effectiveSubdivisions = rules.allowedSubdivisions;
}
```
...
const allUnits = [
  ...rhythmUnit1Nodes, ...rhythmUnit2Nodes,
  // ... all 8
];

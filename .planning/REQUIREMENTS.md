...
- [ ] **INTV-02**: User identifies as Step, Skip, or Leap (age-appropriate vocabulary)
- [ ] **INTV-03**: Ascending intervals before descending in progression
- [ ] **INTV-04**: Piano keyboard SVG reveals played notes after answer

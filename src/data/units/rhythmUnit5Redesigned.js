...
export const rhythmUnit5Nodes = [
  ...
  // ============================================
  {
    ...
    exercises: [
      {
        // G-24: RHYTHM -> RHYTHM_TAP (DISCOVERY policy)
  ...
  // ============================================
  {
    ...
    exercises: [
      {
        // G-25: RHYTHM -> RHYTHM_TAP (PRACTICE policy)
        type: EXERCISE_TYPES.RHYTHM_TAP,
        config: {
          patternTags: ["dotted-half"],
          tempo: 80,
  ...
  // ============================================
  {
    ...
    exercises: [
      {
        // Already RHYTHM_DICTATION — acceptable for DISCOVERY per policy (RHYTHM_TAP or RHYTHM_DICTATION)
        // G-26: no type change needed per plan note
  ...
  // ============================================
  {
    ...
    exercises: [
      {
        // Already RHYTHM_TAP — correct per PRACTICE policy
        type: EXERCISE_TYPES.RHYTHM_TAP,
        config: {
  ...
  // ============================================
  {
    ...
    exercises: [
      {
        // G-27: RHYTHM -> ARCADE_RHYTHM (SPEED_ROUND policy)
  ...
  // ============================================
  {
    ...
    exercises: [
      // G-28: ARCADE_RHYTHM -> RHYTHM_TAP for both exercises (MINI_BOSS policy)

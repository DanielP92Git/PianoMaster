...
export const bassUnit7Nodes = [
  ...
  // ============================================
  // NODE 2: A Major Practice (Practice)
  // ============================================
  {
    id: 'bass_7_2',
  ...
  // ============================================
  // NODE 4: F Major Practice (Practice)
  // ============================================
  {
    id: 'bass_7_4',
  ...
  // ============================================
  // NODE 6: Bb Major Practice (Practice)
  // ============================================
  {
    id: 'bass_7_6',
  ...
  // ============================================
  // NODE 8: Eb Major Practice (Practice)
  // ============================================
  {
    id: 'bass_7_8',
  ...
  // ============================================
  // NODE 9: Key Sig Memory Mix-Up (Mix-Up - Memory Game)
  // ============================================
  {
    id: 'bass_7_9',
    ...
    noteConfig: {
      notePool: ['C3', 'D3', 'E3', 'F#3', 'G3', 'A3', 'Bb3', 'B3', 'C4'],
      focusNotes: [],
      contextNotes: ['C3', 'D3', 'E3', 'F#3', 'G3', 'A3', 'Bb3', 'B3', 'C4'],
      clef: 'bass',
      ledgerLines: false,
      accidentals: false
    },
    ...
    exercises: [
      {
        // MEMORY_GAME — no keySignature field (memory game does not use key sig glyph)
    ...
    skills: ['C3', 'D3', 'E3', 'F#3', 'G3', 'A3', 'Bb3', 'B3', 'C4'],
    xpReward: 60,
    accessoryUnlock: null,
    isBoss: false,
    isReview: false,
  ...
  // ============================================
  // NODE 10: Key Signature Master (BOSS - boss_bass_keysig)
  ...
  // ============================================
  {
    ...
    exercises: [
      ...
      {
        // Exercise 3: Mixed keys (D major — representative mid-difficulty sharp key)
        type: EXERCISE_TYPES.SIGHT_READING,
        config: {
          notePool: BASS_FULL_OCTAVE,
          measuresPerPattern: 2,

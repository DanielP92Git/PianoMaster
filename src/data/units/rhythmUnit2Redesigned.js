...
export const rhythmUnit2Nodes = [
  ...
  // ============================================
  {
    ...
    exercises: [
      {
        // G-07: RHYTHM -> RHYTHM_TAP (DISCOVERY policy)
  ...
  // ============================================
  {
    ...
    exercises: [
      {
        // G-08: RHYTHM -> RHYTHM_TAP (PRACTICE policy)
        type: EXERCISE_TYPES.RHYTHM_TAP,
        config: {
          patternTags: ["quarter-half-whole"],
          tempo: 70,
  ...
  // ============================================
  {
    ...
    exercises: [
      {
        // G-09: RHYTHM_DICTATION -> RHYTHM_TAP (PRACTICE policy)
        type: EXERCISE_TYPES.RHYTHM_TAP,
        config: {
          patternTags: ["quarter-half-whole"],
          tempo: 70,
  ...
  // ============================================
  {
    ...
    exercises: [
      {
        // G-10: RHYTHM_TAP -> RHYTHM_DICTATION (MIX_UP policy)
  ...
  // ============================================
  {
    ...
    exercises: [
      {
        // G-11: RHYTHM -> ARCADE_RHYTHM (SPEED_ROUND policy)
  ...
  // ============================================
  {
    ...
    exercises: [
      {
        // G-12: ARCADE_RHYTHM -> RHYTHM_TAP (MINI_BOSS policy)
        type: EXERCISE_TYPES.RHYTHM_TAP,
        config: {
          patternTags: ["quarter-half-whole"],
          tempo: 75,

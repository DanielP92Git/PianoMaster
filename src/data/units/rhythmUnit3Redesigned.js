...
export const rhythmUnit3Nodes = [
  ...
  // ============================================
  {
    ...
    exercises: [
      {
        // G-13: RHYTHM -> RHYTHM_TAP (DISCOVERY policy)
  ...
  // ============================================
  {
    ...
    exercises: [
      {
        // G-14: RHYTHM -> RHYTHM_TAP (PRACTICE policy)
        type: EXERCISE_TYPES.RHYTHM_TAP,
        config: {
          patternTags: ["quarter-eighth"],
          tempo: 80,
  ...
  // ============================================
  {
    ...
    exercises: [
      {
        // G-15: RHYTHM_DICTATION -> RHYTHM_TAP (PRACTICE policy)
        type: EXERCISE_TYPES.RHYTHM_TAP,
        config: {
          patternTags: ["quarter-eighth"],
          tempo: 80,
  ...
  // ============================================
  {
    ...
    exercises: [
      {
        // G-16: RHYTHM_TAP -> RHYTHM_DICTATION (MIX_UP policy)
  ...
  // ============================================
  {
    ...
    exercises: [
      {
        // G-17: RHYTHM -> ARCADE_RHYTHM (SPEED_ROUND policy)
  ...
  // ============================================
  {
    ...
    exercises: [
      {
        // G-18: ARCADE_RHYTHM -> RHYTHM_TAP (MINI_BOSS policy)
        type: EXERCISE_TYPES.RHYTHM_TAP,
        config: {
          patternTags: ["quarter-eighth"],
          tempo: 80,

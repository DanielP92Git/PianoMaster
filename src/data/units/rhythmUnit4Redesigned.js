...
export const rhythmUnit4Nodes = [
  ...
  // ============================================
  {
    ...
    exercises: [
      {
        // G-19: RHYTHM -> RHYTHM_TAP (DISCOVERY policy)
        type: EXERCISE_TYPES.RHYTHM_TAP,
        config: {
          patternTags: ["with-quarter-rest"],
          tempo: 65,
          measureCount: 1,
          timeSignature: "4/4",
  ...
  // ============================================
  {
    ...
    exercises: [
      {
        // G-20: RHYTHM -> RHYTHM_TAP (PRACTICE policy)
        type: EXERCISE_TYPES.RHYTHM_TAP,
        config: {
          patternTags: ["with-quarter-rest"],
          tempo: 70,
  ...
  // ============================================
  {
    ...
    exercises: [
      {
        // G-21: RHYTHM_DICTATION -> RHYTHM_TAP (PRACTICE policy)
        type: EXERCISE_TYPES.RHYTHM_TAP,
        config: {
          patternTags: ["with-half-rest"],
          tempo: 70,
  ...
  // ============================================
  {
    ...
    exercises: [
      {
        // G-22: RHYTHM -> ARCADE_RHYTHM (SPEED_ROUND policy)
  ...
  // ============================================
  {
    ...
    exercises: [
      {
        // G-23: ARCADE_RHYTHM -> RHYTHM_TAP (MINI_BOSS policy)
        type: EXERCISE_TYPES.RHYTHM_TAP,
        config: {
          patternTags: [
            "with-quarter-rest",

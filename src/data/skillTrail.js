...
export const UNITS = {
  ...
  RHYTHM_2: {
    ...
    name: "Beat Builders",
    description:
      "Explore half notes and whole notes — long sounds that fill the bar",
    order: 2,
    theme: "Long & Steady",
    icon: "⚡",
    reward: {
  ...
  RHYTHM_3: {
    ...
    description:
      "Meet eighth notes — two quick sounds that share one beat",
    order: 3,
    theme: "Quick Steps",
    icon: "🎶",
    reward: {
  ...
  RHYTHM_4: {
    ...
    name: "Quiet Moments",
    description:
      "Learn to count silence — quarter rests and half rests",
    order: 4,

...
export const UNITS = {
  ...
  // RHYTHM UNITS
  // ============================================
  // Phase 1 v3.5: Pedagogical restructure — 10 rhythm units
  // (durations U1-U3 → subdivisions U4-U5 → dotted U6-U7 → meters U8-U9 → review U10)
  // Name strings must match `units.names.*` keys in src/locales/{en,he}/trail.json (Plan 03).
  RHYTHM_1: {
    id: "rhythm_unit_1",
  ...
  RHYTHM_5: {
    ...
    reward: {
      type: "accessory",
      id: "rhythm_sixteenth_badge",
      name: "Sixteenth Badge",
    },
  },
  RHYTHM_6: {
    id: "rhythm_unit_6",
    ...
    reward: {
      type: "accessory",
      id: "rhythm_dotted_half_badge",
      name: "Dotted Half Badge",
    },
  },
  RHYTHM_7: {
    id: "rhythm_unit_7",
    ...
    reward: {
      type: "accessory",
      id: "rhythm_dotted_quarter_badge",
      name: "Dotted Quarter Badge",
    },
  },
  RHYTHM_8: {
    id: "rhythm_unit_8",
  ...
  RHYTHM_9: {
    ...
    reward: {
      type: "accessory",
      id: "rhythm_six_eight_badge",
      name: "Six-Eight Badge",
    },
  },
  RHYTHM_10: {
    id: "rhythm_unit_10",
    ...
    reward: {
      type: "accessory",
      id: "rhythm_master_badge",
      name: "Rhythm Master Badge",
    },
  },
  RHYTHM_SYNCO: {
    // HIDDEN-V1 sibling entry — describes the hidden Syncopation unit (rhythm_synco_*).
    // Pre-authored so the re-enable path in expandedNodes.js is mechanical (no UNITS
    // map editing needed at re-enable time). See expandedNodes.js HIDDEN-V1 block.

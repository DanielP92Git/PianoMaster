...
export function YourGroove({ onBack }) {
  ...
  const handleBarChange = (newCount) => {
    if (newCount < composition.length) {
      ...
      setComposition([...composition, ...Array(newCount - composition.length).fill([])]);
    }
        ...
        <div className="flex gap-8">
          <div className="flex-1">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
              <h2 className="text-xl font-bold text-gray-800 mb-4">Available Rhythms</h2>
                  ...
                  .map(([_, rhythms]) =>
                    rhythms.map((rhythm) => (
                      <button
                        ...
                        className="p-4 text-2xl bg-gray-50 rounded-lg hover:bg-indigo-50 transition-colors"
                      >
                        {rhythm.symbol}
                      </button>
                    ))
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h2 className="text-xl font-bold text-gray-800 mb-4">Your Composition</h2>
              <div className="space-y-4">
                {composition.map((bar, barIndex) => (
                  <div
                    key={barIndex}
                    className="border-2 border-gray-200 rounded-lg p-4 min-h-[80px] flex items-center"
                  >
                    <span className="text-gray-500 mr-4">Bar {barIndex + 1}</span>
                    <div className="flex gap-2 flex-wrap">
                      {bar.map((note, noteIndex) => (
                        ...
                        >
                          ...
                          <button
                            onClick={() => removeNoteFromBar(barIndex, noteIndex)}
          ...
          >
            <div className="p-6">
              ...
              {/* Rhythm Types */}
              <div className="mb-8">
                <h3 className="font-semibold text-gray-700 mb-3">Rhythm Types</h3>
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          if (e.target.checked) {
                            ...
                            setSelectedRhythms(selectedRhythms.filter(t => t !== type));
                          }
                        }}
                        className="mr-2"
                      />
              ...
              {/* Time Signature */}
              <div className="mb-8">
                <h3 className="font-semibold text-gray-700 mb-3">Time Signature</h3>
                <select
                  value={timeSignature}
              ...
              {/* Number of Bars */}
              <div>
                <h3 className="font-semibold text-gray-700 mb-3">Number of Bars</h3>
                <div className="flex items-center space-x-4">
                  <button
                    onClick={() => handleBarChange(Math.max(1, numberOfBars - 1))}

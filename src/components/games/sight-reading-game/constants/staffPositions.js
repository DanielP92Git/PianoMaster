...
// Note frequency mappings (A4 = 440Hz, equal temperament)
// Accidentals: each sharp/flat is one semitone (×2^(1/12)) above/below the natural.
// Both sharp and flat spellings are provided for enharmonic equivalents.

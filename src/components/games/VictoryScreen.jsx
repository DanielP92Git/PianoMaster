...
const VictoryScreen = ({
  ...
  return (
    <div className="flex items-start sm:items-center justify-center min-h-screen fixed inset-0 p-3 sm:p-4 pt-14 sm:pt-8 pb-3 sm:pb-4 overflow-y-auto">
      <div className="relative w-full max-w-md mx-auto p-5 sm:p-6 md:p-6 pt-10 sm:pt-12 md:pt-10 rounded-2xl bg-gradient-to-br from-white to-gray-50 shadow-[0_8px_30px_rgb(0,0,0,0.12)] backdrop-blur-sm font-outfit animate-floatUp">
        <div className="absolute top-1 sm:top-2 md:top-3 left-1/2 -translate-x-1/2">
          <div className="relative">
            ...
            <Trophy
              className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-yellow-500 animate-celebration"
              strokeWidth={1.5}
            />
          </div>
        </div>

        <div className="text-center mt-1 sm:mt-2 md:mt-4 space-y-2 sm:space-y-3 md:space-y-4">
          ...
          <div className="relative py-1">
            ...
            <h2 className="relative text-2xl sm:text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-600 via-pink-600 to-red-600">
              Victory!
            </h2>
            {/* Floating sparkles */}
          ...
          {scorePercentage >= 80 && (
            <div className="relative py-2 sm:py-3 md:py-4 px-3 sm:px-4 md:px-6 rounded-xl overflow-hidden">
              ...
              <div className="relative flex items-center justify-center gap-1.5 sm:gap-2">
                <Star className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-yellow-300 animate-spin" />

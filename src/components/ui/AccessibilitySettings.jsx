...
const AccessibilitySettings = ({ className = "", ...props }) => {
  ...
  const AccessibilityToggle = ({
    ...
    <div className="flex items-start space-x-4 p-4 rounded-kids-lg border border-gray-200 dark:border-gray-700">
      ...
      <Card variant="solid" highContrast={highContrast}>
        ...
        <CardContent>
          <Stack spacing={6}>
            {/* Visual Settings */}
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white font-rounded mb-4 flex items-center">
                <Eye className="w-5 h-5 mr-2 text-kidsPrimary-600" />
                Visual Settings
              </h3>
              <Stack spacing={3}>
                <AccessibilityToggle
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white font-rounded mb-4 flex items-center">
                <Keyboard className="w-5 h-5 mr-2 text-kidsPrimary-600" />
                Navigation Settings
              </h3>
              <Stack spacing={3}>
                <AccessibilityToggle
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white font-rounded mb-4 flex items-center">
                <Volume2 className="w-5 h-5 mr-2 text-kidsPrimary-600" />
                Audio Settings
              </h3>
              <Stack spacing={3}>
                <VolumeControl />
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white font-rounded mb-4 flex items-center">
                <MousePointer className="w-5 h-5 mr-2 text-kidsPrimary-600" />
                Motor Settings
              </h3>
              <Stack spacing={3}>
                <AccessibilityToggle
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white font-rounded mb-4 flex items-center">
                <Settings className="w-5 h-5 mr-2 text-kidsPrimary-600" />
                Cognitive Settings
              </h3>
              <Stack spacing={3}>
                <AccessibilityToggle

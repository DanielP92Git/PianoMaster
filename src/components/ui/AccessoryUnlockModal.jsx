...
const AccessoryUnlockModal = ({ accessories, onClose, onEquip }) => {
  ...
  const modalContent = (
    <div className="fixed left-0 top-0 z-[10000] flex h-screen w-screen items-center justify-center bg-black/70 p-4 backdrop-blur-sm">
      {/* Confetti particles */}
      ...
      <div className="relative w-full max-w-md">
        ...
        <button
          onClick={onClose}
          className="absolute -right-2 -top-2 z-10 flex h-8 w-8 items-center justify-center rounded-full bg-white/20 text-white/90 transition-colors hover:bg-white/30 sm:-right-4 sm:-top-4"
          aria-label="Close"
        >
        ...
        {/* Main content */}
        <div className="relative overflow-hidden rounded-2xl border border-white/20 bg-gradient-to-br from-purple-900/95 via-indigo-900/95 to-blue-900/95 p-6 shadow-2xl sm:p-8">
          {/* Glow effect */}
          <div
            ...
            <div className="relative flex items-center justify-center py-4 sm:py-8">
              ...
              >
                <div className="relative">
                  ...
                  {/* Accessory image */}
                  <div className="relative h-32 w-32 overflow-hidden rounded-2xl border-4 border-yellow-400/50 bg-gradient-to-br from-purple-500/20 to-blue-500/20 shadow-2xl sm:h-40 sm:w-40">
                    <img

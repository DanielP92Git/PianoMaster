...
const BUBBLE_COLORS = {
  treble_clef: [
    {
      bg: "radial-gradient(circle at 35% 35%, #93c5fd, #3b82f6 60%, #1d4ed8)",
      shadow: "59,130,246",
    },
    {
      bg: "radial-gradient(circle at 35% 35%, #c4b5fd, #8b5cf6 60%, #6d28d9)",
      shadow: "139,92,246",
    },
    {
      bg: "radial-gradient(circle at 35% 35%, #f9a8d4, #ec4899 60%, #be185d)",
      shadow: "236,72,153",
    },
    {
      bg: "radial-gradient(circle at 35% 35%, #a5b4fc, #6366f1 60%, #4338ca)",
      shadow: "99,102,241",
    },
    {
      bg: "radial-gradient(circle at 35% 35%, #67e8f9, #06b6d4 60%, #0e7490)",
      shadow: "6,182,212",
    },
    {
      bg: "radial-gradient(circle at 35% 35%, #d8b4fe, #a855f7 60%, #7e22ce)",
      shadow: "168,85,247",
    },
    {
      bg: "radial-gradient(circle at 35% 35%, #fda4af, #f43f5e 60%, #be123c)",
      shadow: "244,63,94",
    },
  ],
  bass_clef: [
    ...
    {
      bg: "radial-gradient(circle at 35% 35%, #e9d5ff, #c084fc 60%, #9333ea)",
      shadow: "192,132,252",
    },
    {
      bg: "radial-gradient(circle at 35% 35%, #818cf8, #4f46e5 60%, #3730a3)",
      shadow: "79,70,229",
    },
    {
      bg: "radial-gradient(circle at 35% 35%, #f0abfc, #d946ef 60%, #a21caf)",
      shadow: "217,70,239",
    },
    {
      bg: "radial-gradient(circle at 35% 35%, #93c5fd, #3b82f6 60%, #1d4ed8)",
  ...
  rhythm: [
    {
      bg: "radial-gradient(circle at 35% 35%, #6ee7b7, #10b981 60%, #047857)",
      shadow: "16,185,129",
    },
    {
      bg: "radial-gradient(circle at 35% 35%, #5eead4, #14b8a6 60%, #0f766e)",
      shadow: "20,184,166",
    },
    {
      bg: "radial-gradient(circle at 35% 35%, #a7f3d0, #34d399 60%, #059669)",
      shadow: "52,211,153",
    },
    {
      bg: "radial-gradient(circle at 35% 35%, #99f6e4, #2dd4bf 60%, #0d9488)",
      shadow: "45,212,191",
    },
    {
      bg: "radial-gradient(circle at 35% 35%, #86efac, #22c55e 60%, #15803d)",
      shadow: "34,197,94",
    },
    {
      bg: "radial-gradient(circle at 35% 35%, #67e8f9, #06b6d4 60%, #0e7490)",
  ...
  boss: [
    {
      bg: "radial-gradient(circle at 35% 35%, #fde68a, #f59e0b 60%, #b45309)",
      shadow: "245,158,11",
    },
    {
      bg: "radial-gradient(circle at 35% 35%, #fcd34d, #eab308 60%, #a16207)",
      shadow: "234,179,8",
    },
    {
      bg: "radial-gradient(circle at 35% 35%, #fed7aa, #f97316 60%, #c2410c)",
      shadow: "249,115,22",
    },
  ],
  ear_training: [
    ...
    {
      bg: "radial-gradient(circle at 35% 35%, #a5f3fc, #22d3ee 60%, #0891b2)",
      shadow: "34,211,238",
    },
  ],
};
...
const TrailNodeModal = ({
  ...
  const NodeIcon = isPremiumLocked
    ? Sparkles
    : getNodeTypeIcon(node.nodeType, node.category);
  ...
  const bubbleColorSet =
    BUBBLE_COLORS[bubbleCategory] || BUBBLE_COLORS.treble_clef;
        ...
        <div className="p-5 sm:p-7">
          ...
          <div className="mb-4 flex justify-center">
            {(() => {
              ...
              if (mStyle) {
                return (
                  <div
                    className="flex h-18 w-18 items-center justify-center rounded-full sm:h-22 sm:w-22"
                    style={{
              ...
              return (
                <div
                  className={`flex h-16 w-16 items-center justify-center rounded-full sm:h-20 sm:w-20 ${headerColors.bg} ${headerColors.glow} ring-4 ring-white/15`}
                >
                  <NodeIcon
                    size={36}
                    className={headerColors.text}
                    strokeWidth={2}
                  />
                </div>
              );
          ...
          <div className="mb-5 text-center">
            ...
            <p className="mt-1 text-sm text-white/60">
              {t(`descriptions.${node.name}`, {
                defaultValue:
                  sanitizeAccidentals(node.description) || t("modal.subtitle"),
              })}
            </p>
          </div>
            ...
            <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
              ...
              {(node.noteConfig?.focusNotes?.length > 0
                ...
                const displaySkill = noteMatch
                  ...
                  : t(`trail:skillNames.${skill}`, {
                      defaultValue: skill.replace(/_/g, " "),
                    });
                const textSizeClass =
                  displaySkill.length > 4
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      className="pointer-events-none absolute text-[6px] text-white/60"
            ...
            <div className="mb-4 animate-pulse space-y-2">
              {stars > 0 && (
                <div className="rounded-xl border border-white/10 bg-white/5 p-3">
                  <div className="mx-auto mb-2 h-3 w-1/3 rounded bg-white/10" />
              ...
              {totalExercises > 1 &&
                node.exercises.map((_, i) => (
                  ...
                  >
                    <div className="h-5 w-5 flex-shrink-0 rounded-full bg-white/10" />
          ...
          {isUnlocked &&
            !isLoading &&
            (stars > 0 || exercisesCompleted > 0) && (
              <div className="mb-4 rounded-xl border border-white/10 bg-white/5 p-3 sm:p-4">
                <h3 className="mb-2 text-center text-sm font-semibold text-white/80">
                  ...
                  <div className="mb-2">
                    ...
                    <div className="h-2 overflow-hidden rounded-full bg-white/10">
                      <div
                        ...
                        style={{
                          width: `${(exercisesCompleted / totalExercises) * 100}%`,
                        }}
                      />
                    </div>
                  </div>
                ...
                {bestScore > 0 && allExercisesComplete && (
                  <p className="text-center text-xs text-white/60 sm:text-sm">
                    ...
                    <span className="font-bold text-white">
                      {t("modal.bestScoreValue", { score: bestScore })}
                    </span>
                  </p>
                )}
              </div>
          ...
          {isUnlocked && !isLoading && totalExercises > 1 && (
            <div className="mb-4">
              <h3 className="mb-2 text-xs font-semibold text-white/80 sm:text-sm">
                {t("modal.exercises")}
              </h3>
              <div className="space-y-1.5 sm:space-y-2">
                {node.exercises.map((exercise, index) => {
                  ...
                  const isLocked =
                    index > 0 && !getExerciseData(index - 1)?.stars;

                  return (
                    <div
                      key={index}
                      className={`flex items-center justify-between rounded-lg px-2 py-1.5 transition-colors sm:px-3 sm:py-2 ${isNext ? `border bg-white/10 ${headerColors.border}` : "bg-white/5"} ${isCompleted ? "bg-emerald-500/10" : ""} `}
                    >
                      <div className="flex items-center gap-1.5 sm:gap-2">
                        {/* Status indicator */}
                        <span className="flex h-5 w-5 items-center justify-center rounded-full text-xs font-medium sm:h-6 sm:w-6 sm:text-sm">
                          {isCompleted ? (
                        ...
                        {/* Exercise name */}
                        <span
                          className={`text-xs sm:text-sm ${isLocked ? "text-white/30" : "text-white/80"}`}
                        >
                        ...
                        {isCompleted && epData ? (
                          ...
                          <>
                            ...
                            <button
                              ...
                              className="whitespace-nowrap rounded-md bg-white/10 px-2 py-1 text-xs font-medium text-white/70 transition-colors hover:bg-white/20"
                          ...
                          <button
                            onClick={() => navigateToExercise(index)}
                            className={`rounded-md ${progressGradient} whitespace-nowrap px-2 py-1 text-xs font-medium text-white transition-transform hover:scale-[1.02]`}
                          >
                            {t("modal.startButton")}
                          </button>
                        ) : null}
          ...
          {/* XP Reward card */}
          <div className="mb-4 flex items-center justify-center gap-4 rounded-xl border border-white/10 bg-white/5 p-4">
          ...
          {node.accessoryUnlock && (
            <div className="mb-4 rounded-lg border border-yellow-400/30 bg-yellow-400/10 p-2.5 sm:p-3">
              <p className="text-center text-xs font-medium text-yellow-300">
                &#127873; {t("modal.unlockLabel")}{" "}
                <span className="font-bold">
                  {t(`trail:accessories.${node.accessoryUnlock}`, {
                    defaultValue: node.accessoryUnlock.replace(/_/g, " "),
                  })}
                </span>
              </p>
            </div>
          ...
          {!isUnlocked &&
            ...
            node.isBoss &&
            node.unlockHint && (
              <div className="mb-4 rounded-xl border-2 border-yellow-500/30 bg-yellow-400/10 p-4 shadow-lg sm:p-5">
                <div className="flex flex-col items-center gap-3 text-center">
                  <div className="flex-shrink-0">
                    <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-yellow-400 to-amber-500 shadow-[0_0_20px_rgba(234,179,8,0.4)] sm:h-14 sm:w-14">
                      <span className="text-3xl sm:text-4xl">&#128274;</span>
                    </div>
                  </div>
                  <div>
                    <h3
                      className="mb-2 text-base font-black uppercase tracking-wide text-yellow-400 sm:text-lg"
                      style={{ textShadow: "0 0 15px rgba(255, 215, 0, 0.3)" }}
                    >
                      {t("modal.bossUnlockTitle", {
                        defaultValue: "How to Unlock This Challenge",
                      })}
                    </h3>
                    <p className="text-sm font-bold leading-relaxed text-white/80 sm:text-base">
                      {t(`unlockHints.${node.name}`, {
                        defaultValue: node.unlockHint,
                      })}
                    </p>
                  </div>
                </div>
          ...
          {isPremiumLocked && (
            <div className="mb-4 rounded-xl border border-amber-400/30 bg-amber-400/10 p-4 text-center">
            ...
            {isPremiumLocked ? (
              <>
                ...
                <button
                  ...
                  className="flex-1 rounded-full bg-gradient-to-b from-amber-400 to-yellow-500 px-6 py-3 text-base font-bold text-amber-900 transition-transform duration-200 hover:scale-[1.02]"
                >
              ...
              <>
                ...
                <button
                  ...
                  className={`flex-1 rounded-full px-6 py-3 text-base font-bold text-white shadow-lg transition-all duration-200 ${
                    !isUnlocked
                      ? "cursor-not-allowed bg-gray-700 text-gray-500"
                      : isLoading
                        ? `${progressGradient} cursor-wait opacity-70`
